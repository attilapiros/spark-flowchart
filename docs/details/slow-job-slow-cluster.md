...
As of Spark3.4, the driver will note when and for how long it waits for cluster resources to create new executors. Check the JVM metrics for this information. 
